...
// this function listen event from SFDriver, and output changed state to SFDriver.
// write code to listen any kind of event, not limited to counting zsls, but any numeric counts.
